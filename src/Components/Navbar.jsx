          ...
          <div>
            <Navbar light expand="md">
              ...
              <Collapse isOpen={isOpen} navbar>
                ...
                <Nav>
                  <NavItem  >
                    <NavLink className="icon-facebook text-teal d-flex float-right" href="https://web.facebook.com/Codekids-108202741318666" target="_blank" ></NavLink>
                  </NavItem>
                  <NavItem >
                    <NavLink className="icon-twitter text-success d-flex float-right" href="https://twitter.com/CodeKids4" target="_blank" ></NavLink>
                  </NavItem>
                  <NavItem >
                    <NavLink className="icon-linkedin text-yellow d-flex float-right" href="https://www.linkedin.com/in/codekids-forkids-722598207/" target="_blank" ></NavLink>
                  </NavItem>
                  </Nav>
